...
$pdf->Ln(25);
$pdf->Cell(80);
$pdf->Cell(30,10,'SURAT KETERANGAN ASAL - USUL',0,0,'C');
$pdf->Ln(5);
...
$pdf->Ln(7);
$pdf->SetFont('Arial','',13);
$pdf->Cell(50,10,'adalah benar ayah kandung dan ibu kandung dari seorang : ',0,0,'L');
...
$pdf->Ln(5);
$pdf->SetFont('Arial','',13);
$pdf->Cell(50,10,'dengan seorang wanita : ',0,0,'L');
