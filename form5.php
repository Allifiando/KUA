 ...
 <head>
  ...
  <body>
    ...
    <div class="container">
      ...
      <h2 class="text-center" style="text-decoration: underline;">SURAT IZIN ORANG TUA</h2>
      <br>
      ...
      <form class="form-horizontal" method="post" action="">
        ...
        <div class="form-group">
          ...
          <div class="col-sm-2"> 
            <input name="tempatlahirayah" type="text" class="form-control" Placeholder="tempat lahir ayah dari calon suami/istri" id="pwd">
          </div>
          <div class="col-sm-1"> 
        ...
        <div class="form-group">
          <label class="control-label col-sm-2" for="pwd">Tempat tanggal lahir</label>
          <div class="col-sm-2"> 
            <input value="<?php echo $qq1['tempatlahir'];?>" name="tempatlahir" placeholder="tempat lahir anda" type="text" class="form-control" id="pwd">
          </div>
          <div class="col-sm-1"> 
        ...
        <div class="form-group">
          <label class="control-label col-sm-2" for="email">Nama lengkap dan alias</label>
          <div class="col-sm-7">
            <input value="<?php echo $qq2['namalengkap'];?>" name="namalengkapistri" type="text" class="form-control" Placeholder="nama calon istri" id="email">
          </div>
        </div>
        ...
        <div class="form-group">
          ...
          <div class="col-sm-6"> 
            <input value="<?php echo $qq2['namaa'];?>" name="namalengkapbinti" type="text" class="form-control" Placeholder="nama orang tua calon istri" id="pwd">
          </div>
        </div>
        ...
        <div class="form-group">
          <label class="control-label col-sm-2" for="pwd">Tempat tanggal lahir</label>
          <div class="col-sm-2"> 
            <input value="<?php echo $qq2['tempatlahir'];?>" name="tempatlahiristri" type="text" class="form-control" Placeholder="tempat lahir calon istri" id="pwd">
          </div>
           <div class="col-sm-1"> 
            <select name="tgllahiristri" class="form-control" id="sel1">
              <?php for($i=1; $i<32; $i++): ?>
              <option value="<?php echo $i;?>"><?php echo $i;?></option>
              <?php endfor; ?>
            </select>
          ...
          <div class="col-sm-2"> 
            <select name="thnlahiristri" class="form-control" id="sel1">
             <?php for($i=1980; $i<=date('Y'); $i++): ?>
              <option value="<?php echo $i;?>"><?php echo $i;?></option>
              <?php endfor; ?>
            </select>
        ...
        <div class="form-group">
          <label class="control-label col-sm-2" for="pwd">Warganegara</label>
          <div class="col-sm-6"> 
            <input value="<?php echo $qq2['warganegara'];?>" name="negaraistri" type="text" class="form-control" Placeholder="negara calon istri" id="pwd">
          </div>
        </div>
        ...
        <div class="form-group">
          ...
          <div class="col-sm-2"> 
            <select class="form-control" id="sel1">
              <option name="agamaistri" value="<?php echo $qq2['agama'];?>"><?php echo $qq1['agama'];?></option>
              <option>Islam</option>
              <option>Kristen</option>
              <option>Katholi</option>
              <option>Budha</option>
        ...
        <div class="form-group">
          <label class="control-label col-sm-2" for="pwd">Pekerjaan</label>
          <div class="col-sm-6"> 
            <input value="<?php echo $qq2['pekerjaan'];?>" name="pekerjaanistri" type="text" class="form-control" Placeholder="pekerjaan calon istri" id="pwd">
          </div>
        </div>
        ...
        <div class="form-group">
          <label class="control-label col-sm-2" for="pwd">Tempat tinggal</label>
          <div class="col-sm-5"> 
            <textarea name="alamatistri" class="form-control" cols="" Placeholder="alamat calon istri" rows="5"><?php echo $qq2['alamat'];?></textarea>
          </div>
        </div>
        ...
        <div class="form-group"> 
          <div class="col-sm-offset-2 col-sm-10">
            ...
            <a href="form6.php"><button name="btnprint" type="button" id="cmd" class="btn btn-primary">Next</button></a>
          </div>
        </div>
      </form>
